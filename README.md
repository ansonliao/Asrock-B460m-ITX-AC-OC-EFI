...
- [x] Big Sur 11.0.1 with OC 0.6.3
- [x] Catalina 10.15.7 with OC 0.6.3
- [x] Catalina 10.15.7 with OC 0.6.2
- [x] Catalina 10.15.7
- [x] Catalina 10.15.6
...
- Fixed BIOS error messages ([#50](https://github.com/ansonliao/Asrock-B460m-ITX-AC-OC-EFI/issues/50))
...
*2022-Mar-13*
- Upgraded OC to `0.7.9`
- Upgraded KEXTs
- Supports Monterey `12.2.1`
...
*2021-Mar-10*
- Upgraded OC to `0.6.7`
- Upgraded KEXTs
- Supported macOS `11.2.3`
